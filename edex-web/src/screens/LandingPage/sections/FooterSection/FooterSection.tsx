...
export const FooterSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-center gap-6 md:gap-[37px] w-full py-8 px-4">
      ...
      <Button
        ...
        className="px-6 py-3 rounded-[100px] bg-[linear-gradient(180deg,rgba(255,194,122,1)_0%,rgba(255,163,55,1)_100%)] hover:opacity-90 transition-opacity font-body-regular-600 font-[number:var(--body-regular-600-font-weight)] text-graywhite text-[length:var(--body-regular-600-font-size)] tracking-[var(--body-regular-600-letter-spacing)] leading-[var(--body-regular-600-line-height)] [font-style:var(--body-regular-600-font-style)]"
      >
        Sign up for Free
      </Button>
    </section>
