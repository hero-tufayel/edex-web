      ...
      <div className="max-w-[1444px] mx-auto">
        ...
        <div className="relative">
          <Button
            variant="ghost"
            size="icon"
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-graywhite rounded-full p-2.5 hover:bg-graywhite"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-12">
            {courseData.map((course) => (
              <Card
                key={course.id}
                className="relative bg-graywhite rounded-3xl border-0 shadow-[0_15px_50px_rgba(109,115,122,0.24)]"
              >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          className={`rounded-full p-2.5 ${
                            course.featured
                              ? "shadow-[-4px_4px_20px_#20b4861f] bg-[linear-gradient(180deg,rgba(255,194,122,1)_0%,rgba(255,163,55,1)_100%)] hover:bg-[linear-gradient(180deg,rgba(255,194,122,1)_0%,rgba(255,163,55,1)_100%)]"
                              : "bg-[linear-gradient(180deg,rgba(255,194,122,0.12)_0%,rgba(255,163,55,0.12)_100%)] hover:bg-[linear-gradient(180deg,rgba(255,194,122,0.12)_0%,rgba(255,163,55,0.12)_100%)]"
                          }`}
                        >
                          {course.featured ? (
                            <img
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 shadow-[-4px_4px_20px_#20b4861f] bg-[linear-gradient(180deg,rgba(255,194,122,1)_0%,rgba(255,163,55,1)_100%)] rounded-full p-2.5 hover:bg-[linear-gradient(180deg,rgba(255,194,122,1)_0%,rgba(255,163,55,1)_100%)]"
          >
